...
namespace OpenTibia.Server.Movement
{
    ...
    internal class OnMapMovementEvent : BaseMovementEvent
    {
        ...
        public OnMapMovementEvent(uint creatureRequestingId, IThing thingMoving, Location fromLocation, byte fromStackPos, Location toLocation, byte count = 1, bool isTeleport = false)
        ...
        private void MoveThing()
        {
            ...
            if (this.FromTile.HasSeparationEvents)
            {
